...
The prepared catalog includes 51 KernelSU Next kernel 6.1 targets, 15 KernelSU Next kernel 6.12/6.6 targets, 156 KernelSU Next 33214 packages, and 122 checksum-verified ReSukiSU packages across OxygenOS 14, 15, and 16. The user reported boot testing of the OP13R pilot stack; other devices are not represented as boot-tested.
